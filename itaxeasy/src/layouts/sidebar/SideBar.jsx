...
export default function Sidebar() {
    ...
    return (
        ...
        <aside 
            class={`${isMenuOpen?"":"-translate-x-full"} fixed top-0 left-0 z-40 w-64 h-screen transition-transform sm:translate-x-0`}
...
function Logo() {
    return (
        <div className="border-solid border-2 border-sky-800 p-4 bg-slate-800 sticky top-0  pl-4 whitespace-nowrap">
            <div class="text-2xl font-bold">ItaxEasy</div>
            <div class="text-sm text-gray-500">Easy Accountancy</div>
        </div>
    )
}
...
function SidebarLinks() {
    ...
    return(
        ...
        <ul class="space-y-2 font-medium sidBarLinks  px-3 py-4  h-full overflow-y-auto">
            {linkData.map((item,i)=>(
...
function SidebarLinkToggle(prop) {
    ...
    console.log(typeof item.nestedData)
    return (
    <li>
        <button onClick={handleLinkClick} type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
